...
<head>
  <meta charset="utf-8">
  <title>Vivero Happy Green</title>
...
<body>
      ...
      <div class="superior">
        ...
        <div class="container">
          <div class="menu-wrap">
            <nav class="menu">
              <div class="icon-list">
                <a class="activo" href="inicio" alt="Bienvenidos a Happy Green">INICIO</a>
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            ...
            <div class=" carousel-caption info">
              <h2 class="hidden-xs hidden-sm hidden-md">Precios Especiales a Constructoras,
                Municipalidades, Paisajistas...</h2>
              <p class="hidden-xs hidden-sm">Venta Mayorista Árboles diferentes alturas, Arbustos, Flores, Cubresuelos
              </p>
  ...
  <!-- fin slide -->
    <article class="container">
      <div class="row contenido-bienvenidos">
        <div class="col-xs-12 cont-titulos">
          <h1>Bienvenidos Happy Green</h1>
        </div>
        <div class="col-xs-12 cont-info">
          <p>Nuestra empresa cuenta con más de 25 años de experiencia en el rubro de viveros. Conocemos el mercado y por ende sabemos lo que el cliente quiere y necesita. Nuestro trabajo y esfuerzos se han centrado siempre en procurar la mejor atención a nuestros clientes, escuchando sus inquietudes para lograr darles las mejores recomendaciones  tanto prácticas como decorativas para su jardín.
          <br></br>
          Por el conocimiento obtenido a lo largo de estos 25 años y queriendo siempre dar un paso adelante, es que hemos desarrollado un proyecto totalmente innovador en el área de la jardinería, diseño y decoración de exteriores, llamado HAPPY GREEN.
          </p>
        </div>
      </div>
    </article>
    ...
    <div class="row fondo-dest">
      <div class="container container-destacados">
        <div class="row cont_dest">
          ...
          <div class="col-xs-12 cont-destacados">

            <!-- destacado 1 -->
            <div class="grid col-xs-12 col-sm-6 col-md-3">
              <a href="detalleproducto">
                <figure class="effect-zoe">
                  <img class="destacada" src="imagenes/destacados/1.jpg" alt="planta destacada">
                  <figcaption>
                    <h2>
              ...
              <div class="info-producto">
                <h4>
                    Lorem ipsum ad his script.
                </h4>
                <p>Ad his script a blandit parti endo
                  eum fastidii ac cumsan euripidi
                  in, eum liber hendrerit.
                </p>
                <a class="detalle" href="detalleproducto" alt="detalle del producto">DETALLE</a></a>
              </div>
            </div>
            <!-- fin destacado 1 -->
            ...
            <div class="grid col-xs-12 col-sm-6 col-md-3">
              <a href="detalleproducto">
                <figure class="effect-zoe">
                  <img class="destacada" src="imagenes/destacados/2.jpg" alt="planta destacada">
                  <figcaption>
                    <h2>
                      <img src="imagenes/iconos/flor.png">
                    </h2>
            ...
            <div class="grid col-xs-12 col-sm-6 col-md-3">
              <a href="detalleproducto">
                <figure class="effect-zoe">
                  <img class="destacada" src="imagenes/destacados/3.jpg" alt="planta destacada">
                  <figcaption>
                    <h2>
                      <img src="imagenes/iconos/flor.png">
                    </h2>
            ...
            <div class="grid col-xs-12 col-sm-6 col-md-3">
              <a href="detalleproducto">
                <figure class="effect-zoe">
                  <img class="destacada" src="imagenes/destacados/4.jpg" alt="planta destacada">
                  <figcaption>
                    <h2>
                      <img src="imagenes/iconos/flor.png">
                    </h2>
      ...
      <div class="container container-footer">
        <div class="col-xs-12 col-sm-4 col-md-4 contacto">
          <div class="contacto-pie">
            <h4>Menú</h4>
            <a class="activo" href="index" alt="Bienvenidos a Happy Green">Inicio</a>
